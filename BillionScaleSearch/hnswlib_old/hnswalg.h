...
namespace hnswlib_old {
    ...
    public:
        ...
        HierarchicalNSW(const std::string & infoLocation, const std::string & edgeLocation, std::vector<float>& Data);
        ~HierarchicalNSW();
        ...
        void SaveInfo(const std::string &location, bool visualize = true);
        void SaveEdges(const std::string &location, bool visualize = true);
